...
<div class="container" style="padding-top:15px;margin-top:2%;">
<div class="row">
...
<h5>Organization</h5>
    ...
    <hr>
    <select style="padding:0px 35%;border:1px solid grey;border-radius:5px;">
      
<option value=""><?php echo $organization= $this->session->userdata('organization'); ?></option>
</select>
    <form method="post"id="form" name="form" action="<?php echo base_url().'index.php/Positions/create'; ?>">
<div class="row" >
   
    <div class="col-sm-12">
    
   <div class="form-group">
       <label><b>Add Position</b></label>
       <input type="hidden" name="p_id" value="<?php echo set_value('p_id'); ?>" class="form-control">
    ...
    <label><h5>List Of Posiitons</h5></label>
  ...
  <tbody>
      ...
      <td><?php echo $organization  ?></td>
          ...
          <td> <a href="<?php echo base_url().'index.php/Positions/edit/?p_id='.$c['p_id'] ?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  Edit</a></td>
          <td> <a href="<?php  echo base_url().'index.php/Positions/delete/?p_id='.$c['p_id'] ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a></td>
      </tr>
      <?php  }} else { ?>
        <tr> 
