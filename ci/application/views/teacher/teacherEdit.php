...
<div class="navbar" style="background-color:grey;display:inline-block;border:5px solid white;border-radius:15px;margin-left:30%;margin-top:2%;">
        <div class="container">
      <a href="#" class="navbar-brand" style="color:white;">Update Nominee</a>
...
<div class="container" style="padding-top:20px;">
    ...
    <hr>
    <form method="post" id="form" name="form" action="<?php echo base_url().'index.php/Teacher/edit?n_id='.$teacher['n_id']; ?>">
<div class="row" >
   ...
   <div class="form-group">
       ...
       <input type="text" name="nominee" value="<?php echo set_value('nominee',$teacher['nominee']); ?>" class="form-control">
       <?php  //echo form_error('name'); ?>
       </div>
      
       <p>You can only update nominee name :</p>
